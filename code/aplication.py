...
with mlflow.start_run(experiment_id=experiment_id, run_name = 'PipelineAplicacao'):
    ...
    data_prod.to_parquet('D:\\repositorios\\kobe-dataset\\data\\processed\\prediction_prod.parquet')
    mlflow.log_artifact('D:\\repositorios\\kobe-dataset\\data\\processed\\prediction_prod.parquet')
